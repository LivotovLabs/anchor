...
1) Run `./gradlew :anchor:publishToMavenLocal`
2) Open `~/.m2/repository/labs/livotov/eu/`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :anchor:publishAndReleaseToMavenCentral --no-configuration-cache`
